...
const {createOrderViewModel} = require("./order.service");
...
module.exports.checkOrder = async function(req, res) {
    try {
...
module.exports.allOrdersByEmail = async function(req, res) {
    try {
...
module.exports.adminAllOrdersByEmail = async function(req, res) {
    try {
        const orders = await OrderService.readAllOrdersByEmail(req.body.email);
        let ordersVM = [];
        for (let order of orders) {
...
module.exports.adminSetOrderStatus = async function(req, res) {
    try {
...
// read
module.exports.readOrderById = async function(req, res) {
    try {
...
// readAll
module.exports.readAllOrders = async function(req, res) {
    try {
